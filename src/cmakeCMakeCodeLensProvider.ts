...
export class CMakeCodeLensProvider implements vscode.CodeLensProvider {
    public provideCodeLenses(document: vscode.TextDocument, token: vscode.CancellationToken): vscode.CodeLens[] {
        try {
            ...
            if (matcher.definitions) {
                ...
                //                     return new vscode.CodeLens(locationToRange(elt.location), {title: "1 Reference", command: ""});
